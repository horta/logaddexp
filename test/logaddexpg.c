...
int main(void)
{
    if (test_logaddexpg_values()) return 1;

    if (test_logaddexpg_dbl_max()) return 1;

    if (test_logaddexpg_range_pos()) return 1;

    if (test_logaddexpg_range_neg()) return 1;

    if (test_logaddexpg_hand_made()) return 1;
